      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-2xl shadow-xl shadow-slate-200/50 overflow-hidden border border-slate-100">
          <div className="px-8 py-12 md:px-12 md:py-16">
            ...
            <h1 className="text-3xl md:text-4xl font-black text-slate-900 text-center mb-4 tracking-tight">Terms of Service</h1>
            ...
            <div className="space-y-8 text-slate-600 leading-relaxed max-w-3xl mx-auto marker:text-blue-500">
              ...
              <section>
                <h2 className="text-xl font-bold text-slate-900 mb-4">3. Accounts and Security</h2>
                <p>
